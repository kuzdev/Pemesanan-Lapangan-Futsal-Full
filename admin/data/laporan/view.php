  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
      ...
      <form method="get" action="">
        <input type="hidden" name="load" value="laporan"/>
        ...
        <button class="btn btn-success" href="?load=laporan">Reset Filter</button>
    <!--     <a href="?load=laporan">Reset Filter</a> -->
    </form>
    <hr />
    ...
    if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
        ...
        if($filter == '1'){ // Jika filter nya 1 (per tanggal)
            ...
            echo '<button class="btn btn-warning"><a href="data/laporan/print.php?filter=1&tanggal='.$_GET['tanggal'].'">Cetak PDF</a></button><br /><br />';
            ...
            echo '<button class="btn btn-warning"><a href="data/laporan/print.php?filter=2&bulan='.$_GET['bulan'].'&tahun='.$_GET['tahun'].'">Cetak PDF</a></button><br /><br />';
            ...
            echo '<button class="btn btn-warning"><a href="data/laporan/print.php?filter=3&tahun='.$_GET['tahun'].'">Cetak PDF</a></button><br /><br />';
        ...
        echo '<button class="btn btn-warning"><a href="data/laporan/print.php">Cetak PDF</a></button><br /><br />';
