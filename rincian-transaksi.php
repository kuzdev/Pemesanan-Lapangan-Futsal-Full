 <?php
 $SQL =mysql_query("SELECT * FROM tboking WHERE  noInvoice='$_GET[id]'"); 
 $_data=mysql_fetch_array($SQL);
 $tgl = date('d M Y', strtotime($_data['tglInvoice']));
 ...
 echo"
  ...
  <tbody>
    <tr >
    <tr >
    <td><IMG src='assets/images/paragon.png' ></td>
    <td><IMG src='assets/images/paragon.png' ></td>
    <td><IMG src='assets/images/paragon.png' ></td>
    <td><IMG src='assets/images/paragon.png' ></td>
    </tr>
    ...
    <tr>
      <td>Jl. Kabupaten - 0822-1337-5777</td>
